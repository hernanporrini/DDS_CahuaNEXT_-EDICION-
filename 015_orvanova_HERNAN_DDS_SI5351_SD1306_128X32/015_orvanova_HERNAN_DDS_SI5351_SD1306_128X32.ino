...
void set_frequency(short dir) 
  ...
  if (encoder == 1) 
    {                         
    if (dir == 1) 
    {freq = freq + fstep; if (freq>=7000000) freq=7000000;}
    if (dir == -1) 
...
void setup() 
  ...
  if (digitalRead(band40) == LOW && banda!=2) {freqbanda= 4900000;banda=2;modo=0;}
  if (digitalRead(band20) == LOW && banda!=3) {freqbanda= 8900000;banda=3;modo=1;}
  tunegen();  
  }
...
void displayfreq() 
  ...
  if (stp == 5) {display.print("100kHz");display.drawTriangle( 41, 37,  51, 37,  46, 35, WHITE);} 
