...
#define band80     12        //Este pin se usa para que el micro sepa que se selecciono la banda de 40
...
#define meterVDC   A2        //pin de entrada analogica del indicador de tension de entrada
...
void displayfreq() 
  ...
  volt=(float(analogRead(meterVDC))/1024.0)*23.44;
