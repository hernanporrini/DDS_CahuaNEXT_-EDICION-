...
#define meterRX    A1        //pin de entrada analogica del indicador de tension de entrada
#define meterTX    A2        //pin de entrada analogica del indicador de potencia de salida
#define meterVDC   A3        //pin de entrada analogica del indicador de recepcion
...
void displayfreq() 
  ...
  volt=(float(analogRead(meterVDC))/1024.0)*15.9;
  display.print(volt);
  display.print("V");
